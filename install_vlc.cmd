...
SET vlcversion=3.0.16

::Set your installation source path. E.g. 64Bit results in -> \\domain.local\dfs\software\VLC\3.0.16\vlc-3.0.16-win64.exe
...
::Set your desired log file name scheme. E.g. results in -> GPO_Install_VLC_YourPCName_3.0.16.log
